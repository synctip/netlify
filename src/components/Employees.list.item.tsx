...
type EmployeeListItemComponent = React.FC<Employee & {
    salary?: string | number;
    onDelete?: (event: React.MouseEvent<HTMLButtonElement>, name: string) => void;
}>;

const EmployeeListItem: EmployeeListItemComponent = ({ minutes, name, hours, salary = 0, onDelete }) => {
    ...
    return (
        ...
        >
            <div
                ...
                <h3 style={{ width: '100%' }}>{hours}:{minutes}</h3>
